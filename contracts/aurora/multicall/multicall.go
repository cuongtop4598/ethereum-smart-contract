...
//
// Solidity: function aggregate((address,bytes)[] calls) view returns(uint256 blockNumber, bytes[] returnData, bool[] results)
func (_Multicall *MulticallCaller) Aggregate(opts *bind.CallOpts, calls []MulticallCall) (struct {
	...
	outstruct.Results = *abi.ConvertType(out[2], new([]bool)).(*[]bool)
